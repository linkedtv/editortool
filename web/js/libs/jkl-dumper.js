// ================================================================
//  jkl-dumper.js ---- JavaScript Kantan Library for Data Dumper
//  Copyright 2005 Kawasaki Yusuke <u-suke@kawa.net>
//  2005/05/18 - First Release
//  ===============================================================

// with a little modification by masaka (search string 'masaka' to find)
/******************************************************************
    ...
    case "object":
        if ( data == null ) {
            ...
            for ( var key in data ) {
				...
				// below commented out by masaka, since JSON requires all ames must be quoted - 2006-03-31
